...
All three buttons share one lead, soldered straight into the board. Four plated through-holes with a feed-through strain relief, one per button signal plus a fourth for the ground return they have in common. So the case buttons are built and fitted as one harness rather than three. Use 28 AWG stranded with silicone insulation - the halves stay tethered, so this wire gets flexed every time the unit is opened. I've not settled on buttons yet. There are two options - either side-mounted tactile smd buttons like [these](https://www.amazon.co.uk/ECSiNG-Momentary-5x7-8x3-5mm-Controls-Dashboards/dp/B0GFPX8CMW/ref=sr_1_3?sr=8-3), or through hole button like [this](https://www.amazon.co.uk/10PCS-Momentary-Push-Button-Switch/dp/B0FHVRM49T/ref=sr_1_3?sr=8-3).
